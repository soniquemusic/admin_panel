...
function AdminForm({ isLightMode }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const authorsResponse = axios.get('https://admin-panel-five-woad.vercel.app/sonique/author/get-authors');
                const albumsResponse = axios.get('https://admin-panel-five-woad.vercel.app/sonique/album/get-album');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://admin-panel-five-woad.vercel.app/sonique/song/create-song', formDataToSend, {
                headers: {
